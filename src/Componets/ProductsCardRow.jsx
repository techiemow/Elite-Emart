      ...
      <div className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
        ...
        {IsLoading ? (
          ...
          productData.map((product) => (
            <Link key={product._id} to={"Product/" + product._id} className='w-full min-w-[330px] sm:min-w-[380px] max-w-[330px] sm:max-w-[380px] h-36 bg-white rounded-sm shadow flex'>
