...
const EditUploadProducts = ({EditData,onClose,fetchallproducts}) => {
    ...
    const [data, setData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        const response = await axios.put(`${apiurl}/EditProducts`,{
          data
        },{
  ...
  return (
    ...
    <DialogActions>
      ...
      <Button onClick={handleSubmit} color="primary" variant="contained">Update Product</Button>
    </DialogActions>
...
export default EditUploadProducts