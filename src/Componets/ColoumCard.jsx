...
const ColoumCard = ({IsLoading,productData=[]}) => {
  ...
  return (
    ...
    <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between gap-6 md:gap-1 overflow-x-scroll scrollbar-none transition-all'>
      {IsLoading ? (
